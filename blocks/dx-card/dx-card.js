...
var containerTwoInsideDivFourValue = document.querySelector('.dx-card > div > div > p'),innerHTML;
...
var containerTwoInsideDivSevenValue = document.querySelector('.dx-card > div > div > p').textContent;
